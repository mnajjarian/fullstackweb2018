...
const App = () => {
  ...
  const handleNotify = (title) => {
    setNotification(`a new anecdote ${title} created`)
    setTimeout(() => {
  ...
  return (
    <div>
      ...
      <Switch>
        <Route exact path="/" component={() =>  <AnecdoteList anecdotes={anecdotes} />} />
        <Route exact path="/create" component={() =>  <CreateNew addNew={addNew} handleNotify={handleNotify} />} />
        <Route exact path="/about" component={About} />
        <Route exact path="/anecdotes/:id" component={({match}) => anecdote(match)} />
      </Switch>
      <Footer />
    </div>
  )
